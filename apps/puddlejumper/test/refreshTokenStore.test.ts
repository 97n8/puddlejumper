...
// Patch the DATA_DIR used by refreshTokenStore before it's imported.
// The store resolves DATA_DIR from its module's __dirname; override via env.
...
const {
  ...
  purgeExpired,
  resetDb,
} = await import("../src/api/refreshTokenStore.js");
