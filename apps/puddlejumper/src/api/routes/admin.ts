...
//   PATCH /api/admin/workspace/:id/plan — plan changes
//   GET  /api/admin/audit/export — export legacy audit events as CSV or JSON
//
// Canon audit endpoints (/api/audit, /api/audit/:process_id,
// /api/audit/divergence) live in src/routes/audit.routes.ts.
//
