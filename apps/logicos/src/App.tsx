...
function App() {
  ...
  const isMobileGoogleDrivePath = location.pathname === '/mobile/google-drive'
  const isMobilePreviewPath = location.pathname === '/mobile'
  ...
  useEffect(() => {
    ...
    const isValidPath = (
      ...
      location.pathname === '/mobile/google-drive' ||
  ...
  if (isMobileGoogleDrivePath) {
    return <LogicOSGoogleDrivePage />
  }

  if (isMobilePreviewPath) {
    return <LogicOSMobilePage />
  }
  ...
  return (
    ...
    >
      ...
      <FileEditor
        ...
        casespaceId={currentCaseSpaceId}
        userId={user?.sub}
      />
    </main>
  )
