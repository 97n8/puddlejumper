...
export type PjDraftState = 'working' | 'ready' | 'abandoned'

export interface PjDraftPayload {
  path: string
  content: string
  cursorLine?: number
  cursorCol?: number
...
export interface PjDraftRecord {
  draftId: string
  formType: string
  formKey: string
  casespaceId: string
  authorPrincipalId: string
  draftState: PjDraftState
  payload: PjDraftPayload
  path: string
  content: string
  cursorLine?: number
  cursorCol?: number
...
export interface CreateDraftRequest {
  ...
  cursorCol?: number
  baseContentHash?: string
  draftState?: Extract<PjDraftState, 'working' | 'ready'>
}
