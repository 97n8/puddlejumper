...
<div class="wrap">
  <div class="header">
    ...
    <div class="stamp">Generated by LogicOS</div>
  </div>
  <div class="content">
    ${body}
  </div>
  <div class="footer">
    ...
    <span><strong>Town of ${town}</strong> · Powered by LogicOS / PublicLogic</span>
  </div>
</div>
</body>
</html>`
...
<div class="section">
  ...
  const ctaSection = `
<div class="cta">
  <a class="btn" href="https://os.publiclogic.org">Open LogicOS → Take Action</a>
</div>`
...
<div class="section">
  ...
  const ctaSection = `
<div class="cta">
  <a class="btn" href="https://os.publiclogic.org">Open LogicOS → Review & Sign Off</a>
</div>
...
export function MunicipalAutomationsPanel({ envId, town }: Props) {
  ...
  const automations: AutomationDef[] = [
    ...
    },
    {
      ...
      description: `The moment a request is submitted, LogicOS fires a statute-compliant acknowledgment to the resident — case number, legal response deadline, case tracker link, and Records Officer contact. No staff touches required.`,
    ...
    },
    {
      ...
      description: `Consolidates every case sitting in REVIEW or APPROVAL into one rich document sent to decision-makers. Cases are sorted by urgency, with deadline countdown badges and a direct link to act in LogicOS.`,
