...
function assertControlledPath(candidatePath, purpose) {
...
export async function exportSqliteDatabase(sourcePath, destinationPath) {
...
export function validateSqliteRestore(dbPath) {
