...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      {/* ── Header ──────────────────────────────────────────── */}
      <header className="border-b border-zinc-800 bg-zinc-900/70" role="banner">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={logout}
                  className="rounded-full border border-zinc-700 px-3 py-1 text-xs text-zinc-400 transition hover:border-zinc-500 hover:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
                >
                  Sign out
                </button>
              </div>
      ...
      <main data-test="pl-launcher" className="mx-auto flex max-w-5xl flex-col gap-10 px-6 py-10" role="main">
        {/* ── Login ────────────────────────────────────────── */}
        {!user && (
          <section className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 shadow-lg">
            ...
            <div className="flex flex-col gap-3 max-w-md">
              <button
                ...
                className="flex items-center justify-center gap-3 rounded-lg bg-zinc-100 px-5 py-3 text-sm font-medium text-zinc-900 transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
              >
              ...
              {showManualLogin && (
                <form onSubmit={handleLogin} className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-end">
                  ...
                  <button
                    ...
                    className="rounded-full bg-emerald-500 px-5 py-2 text-sm font-medium text-emerald-950 transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
                  >
      ...
      <footer className="border-t border-zinc-800 bg-zinc-900/40 py-4 text-center text-xs text-zinc-500">
        PuddleJumper Control Center · PublicLogic Governance Engine
      </footer>
    </div>
  );
}
